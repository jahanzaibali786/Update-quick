                    ...
                    <div class="main-content">
                        ...
                        <div class="top-customer-bar row">
                            <div class="customer-select-group col-3">
                                ...
                                {{ Form::select('customer_id', $customers, null, ['class' => 'form-select', 'id' => 'customer', 'data-url' => route('invoice.customer'), 'required' => 'required',    'data-create-url' => route('customer.create'),
