...
@section('content')
    <style>
        ...
        /* Remove ::after from action dropdown toggle */
        .qbo-table .dropdown-toggle::after {
            display: none !important;
        }

        /* Total Row Styling - injected as actual table row */
        .qbo-table .qbo-total-tr td {
            background: #fff;
        ...
        .qbo-table .qbo-total-tr .total-label {
            color: #6b6c72;
        }

        .qbo-table .qbo-total-tr .total-value {
            font-weight: 600;
            text-align: right;
        }

        /* QBO Style Pagination */
        .qbo-pagination {
            display: flex;
        ...
        .qbo-pagination .page-nav:hover {
            color: #0077c5;
        }

        .qbo-pagination .page-nav.disabled {
            color: #c4c4c4;
            cursor: not-allowed;
        }

        .qbo-pagination .page-info {
            color: #393a3d;
            font-weight: 500;
        }
    ...
    <div class="vendor-header">
        <div class="header-left">
            <a href="{{ route('vender.index') }}" class="back-btn">
                <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                    color="currentColor" focusable="false" aria-hidden="true" style="color: rgb(0, 119, 197);">
                    <path
                        d="M15.009 19.022a1 1 0 0 1-.708-.294L8.31 12.72a.999.999 0 0 1 0-1.415l6.009-5.991a1 1 0 0 1 1.414 1.416l-5.3 5.285 5.285 5.3a1 1 0 0 1-.708 1.706l-.001.001Z"
        ...
        <div class="header-right">
            @can('edit vender')
                <div class="btn-group">
                    <a href="#" data-size="xl" data-url="{{ route('vender.edit', $vendor->id) }}" data-ajax-popup="true"
                        title="{{ __('Edit') }}" class="btn btn-outline-secondary">
                        {{ __('Edit') }}
                    </a>
            ...
            <div class="btn-group">
                <button class="btn btn-success dropdown-toggle" type="button" data-bs-toggle="dropdown"
                    aria-expanded="false" style="background-color: #2ca01c; border-color: #2ca01c;">
                    {{ __('New transaction') }}
                </button>
                <ul class="dropdown-menu">
                    @can('create bill')
        ...
        <div class="vendor-sidebar" id="vendorSidebar">
            <div class="sidebar-header">
                <div class="sidebar-btn-group">
                    ...
                    <a href="#" data-size="lg" data-url="{{ route('vender.create') }}" data-ajax-popup="true"
                        data-title="{{ __('Create New Vendor') }}" class="sidebar-add-btn">
                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" color="currentColor" focusable="false" aria-hidden="true">
                            <path
                                d="m17.983 11.027-5-.007.007-5a1 1 0 0 0-2 0l-.007 5-5-.008a1 1 0 0 0 0 2l5 .008-.008 5a1 1 0 1 0 2 0l.008-5 5 .007a1 1 0 1 0 0-2Z"
                                fill="currentColor"></path>
                        </svg>
                    </a>
                    <div class="sidebar-toggle" onclick="toggleSidebar()">
                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" color="currentColor" focusable="false" aria-hidden="true">
                            <path
                                d="m14.011 8.006-10-.012a1 1 0 0 1 0-2l10 .012a1 1 0 1 1 0 2ZM14 13.006l-10-.012a1 1 0 1 1 0-2l10 .012a1 1 0 0 1 0 2ZM14 18.006l-10-.012a1 1 0 1 1 0-2l10 .012a1 1 0 0 1 0 2ZM20.985 10a1 1 0 0 0-1.71-.7l-1.99 2.009a1 1 0 0 0 .006 1.414l2.009 1.99A1 1 0 0 0 21 14l-.015-4Z"
                                fill="currentColor"></path>
                        </svg>
                    </div>
                </div>
            ...
            <ul class="vendor-list" id="vendorList">
                @foreach ($vendors as $v)
                    <li class="vendor-list-item {{ $v->id == $vendor->id ? 'active' : '' }}"
                        onclick="window.location.href='{{ route('vender.show', \Crypt::encrypt($v->id)) }}'">
            ...
            <div class="vendor-cards-row">
                ...
                <div class="vendor-info-card">
                    ...
                    <div class="vendor-name-section">
                        ...
                        <a href="mailto:{{ $vendor->email ?? '' }}" class="vendor-icon-link"><svg width="20"
                                height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                color="currentColor" focusable="false" aria-hidden="true"
                                aria-describedby="ids-tooltip-f9e6xpm">
                                <path
                                    d="M19 4H5a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h14a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3ZM5 6h14a1 1 0 0 1 1 1v1.279l-7.684 2.562a1.012 1.012 0 0 1-.632 0L4 8.279V7a1 1 0 0 1 1-1Zm14 12H5a1 1 0 0 1-1-1v-6.613l7.051 2.351a3.02 3.02 0 0 0 1.9 0L20 10.387V17a1 1 0 0 1-1 1Z"
                                    fill="currentColor"></path>
                            </svg></a>
                        <a href="tel:{{ $vendor->contact ?? '' }}" class="vendor-icon-link"><svg width="20"
                                height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                color="currentColor" focusable="false" aria-hidden="true"
                                aria-describedby="ids-tooltip-di8pzgn">
                                <path
                                    d="M14.563 22.093a6.953 6.953 0 0 1-4.949-2.05l-5.657-5.657a7.01 7.01 0 0 1 0-9.9l1.994-1.993a2 2 0 0 1 3.041.25l2.358 3.3a1.994 1.994 0 0 1-.213 2.578l-.816.815a1 1 0 0 0 0 1.414l2.828 2.829a1.024 1.024 0 0 0 1.414 0l.816-.815a1.993 1.993 0 0 1 2.577-.213l3.3 2.356a2 2 0 0 1 .252 3.043l-1.993 1.993a6.956 6.956 0 0 1-4.952 2.05ZM7.365 3.908 5.371 5.9a5.006 5.006 0 0 0 0 7.07l5.657 5.658a4.998 4.998 0 0 0 7.072 0l1.993-1.994-3.3-2.357-.815.815a3.075 3.075 0 0 1-4.243 0l-2.828-2.83a3 3 0 0 1 0-4.242l.816-.815-2.358-3.297Z"
                                    fill="currentColor"></path>
                            </svg></a>
                    </div>
                    ...
                    <div class="vendor-notes-section">
                        ...
                        <a href="#" data-size="xl" data-url="{{ route('vender.edit', $vendor->id) }}"
                            data-ajax-popup="true" class="text-primary detail-link">{{ __('Add notes') }}</a>
                    </div>
                </div>
                    ...
                    <div class="summary-item">
                        ...
                        <div class="summary-content">
                            <div class="summary-value">
                                {{ \Auth::user()->priceFormat($vendor->vendorOverdue($vendor->id)) }}</div>
            ...
            <ul class="nav vendor-tabs-qbo" id="vendorTab" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="transaction-tab" data-bs-toggle="tab"
                        ...
                        aria-selected="true">{{ __('Transaction List') }}</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="details-tab" data-bs-toggle="tab" data-bs-target="#details"
                        type="button" role="tab" aria-controls="details"
                        aria-selected="false">{{ __('Vendor Details') }}</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="notes-tab" data-bs-toggle="tab" data-bs-target="#notes" type="button"
                        role="tab" aria-controls="notes" aria-selected="false">{{ __('Notes') }}</button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="vendorTabContent" style="padding: 0px 25px 0px 25px;">
                ...
                <div class="tab-pane fade show active" id="transaction" role="tabpanel"
                    ...
                    <div class="transaction-filter-bar">
                            ...
                            <div class="filter-dropdown-wrapper">
                                <button class="btn btn-link filter-btn" type="button" id="filterToggleBtn">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                        ...
                                        aria-hidden="true" class="c87zJPBCVcBa9+C+gaJN9g==">
                                        <path fill="currentColor"
                                            d="m20.036 15.036-9.19-.01a2.98 2.98 0 0 0-5.62-.01h-1.19a1 1 0 1 0 0 2h1.18a2.981 2.981 0 0 0 5.64.01l9.18.01a1 1 0 0 0 0-2m-11.28 1.68-.04.04a.97.97 0 0 1-1.36 0l-.04-.04a.97.97 0 0 1 0-1.36l.04-.04a.97.97 0 0 1 1.36 0l.04.04a.97.97 0 0 1 0 1.36M20.046 7.056h-1.18a2.99 2.99 0 0 0-2.81-2.02h-.01a2.97 2.97 0 0 0-2.82 2.01l-9.18-.01a1 1 0 1 0 0 2l9.19.01c.142.418.378.798.69 1.11a2.94 2.94 0 0 0 2.12.88 3 3 0 0 0 2.81-1.98h1.19a1 1 0 1 0 0-2m-3.29 1.66-.04.04a.97.97 0 0 1-1.36 0l-.04-.04a.97.97 0 0 1 0-1.36l.04-.04a.97.97 0 0 1 1.36 0l.04.04a.97.97 0 0 1 0 1.36">
                                        </path>
                                    </svg> {{ __('Filter') }}
                                </button>
                                <!-- Filter Popup -->
                                <div class="filter-popup" id="filterPopup">
                                                ...
                                                <div class="col-4">
                                                    <div class="input-group">
                                                        <span class="input-group-text"
                                                            style="font-size: 11px;">From</span>
                                    ...
                                    <div class="filter-popup-footer">
                                        <button type="button" class="btn btn-outline-secondary"
                                            id="filterResetBtn">{{ __('Reset') }}</button>
                                        <button type="button" class="btn btn-success" id="filterApplyBtn"
                                            style="background-color: #2ca01c; border-color: #2ca01c;">{{ __('Apply') }}</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="filter-right">
                            <button class="btn btn-link icon-btn"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" color="currentColor" width="24px" height="24px"
                                    focusable="false" aria-hidden="true" class="icon">
                                    <path fill="currentColor"
                            ...
                            <button class="btn btn-link icon-btn"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                    ...
                                    focusable="false" aria-hidden="true" class="icon">
                                    <path fill="currentColor"
                                        d="M5.292 12.283a1 1 0 1 0 1.415 1.413 1 1 0 0 0-1.415-1.413"></path>
                                    <path fill="currentColor"
                                        d="M19 9.01h-1l.008-5a2 2 0 0 0-2-2l-8-.012a2 2 0 0 0-2 2L6 8.991H5a3 3 0 0 0-3 2.995l-.007 5a3.006 3.006 0 0 0 3 3h1.182a2.965 2.965 0 0 0 2.815 2l6 .008h.006a3 3 0 0 0 2.814-2H19a3.006 3.006 0 0 0 3-3l.007-5A3 3 0 0 0 19 9.01M8.012 3.994l8 .011-.008 5L8 8.994zM14.99 20l-6-.008a1 1 0 1 1 0-2l6 .008a1 1 0 1 1 0 2m5-2.993a1.006 1.006 0 0 1-1 1h-1.183a3 3 0 0 0-2.813-2l-6-.008h-.005a2.97 2.97 0 0 0-2.816 2H4.992a1.006 1.006 0 0 1-1-1l.007-5a1 1 0 0 1 1-1H5l14 .02a1 1 0 0 1 1 1z">
                                    </path>
                                </svg></button>
                            <button class="btn btn-link icon-btn"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24" color="currentColor" width="24px" height="24px"
                    ...
                    <div class="card border-0 shadow-none">
                        <div class="card-body p-0 table-border-style">
                            ...
                            {{-- Total Row will be injected via JavaScript into the table tbody --}}
                            {{-- QBO Style Pagination --}}
                            <div class="qbo-pagination" id="qbo-pagination">
                                <span class="page-nav" id="page-first">First</span>
                                <span class="page-nav" id="page-prev">Previous</span>
                                <span class="page-info" id="page-info">1 - 10 of 0</span>
                                <span class="page-nav" id="page-next">Next</span>
                                <span class="page-nav" id="page-last">Last</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane fade" id="details" role="tabpanel" aria-labelledby="details-tab">
                    <div class="text-end mb-3">
                        <a href="#" data-size="xl" data-url="{{ route('vender.edit', $vendor->id) }}"
                            data-ajax-popup="true" class="btn btn-outline-secondary btn-sm">{{ __('Edit') }}</a>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="tab-pane fade" id="notes" role="tabpanel" aria-labelledby="notes-tab">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="#" data-size="xl" data-url="{{ route('vender.edit', $vendor->id) }}"
                            data-ajax-popup="true" class="text-primary" style="font-size: 14px;">+ Add note</a>
                    </div>
                    @if ($vendor->notes)
                        <p>{{ $vendor->notes }}</p>
                    @else
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#datePresetFilter').on('change', function() {
                ...
                switch (preset) {
                    ...
                    case 'this_week':
                        ...
                        break;
                    case 'this_month':
                        fromDate = new Date(today.getFullYear(), today.getMonth(), 1).toISOString().split(
                            'T')[0];
                        toDate = new Date().toISOString().split('T')[0];
                        break;
                    case 'last_week':
                        ...
                        break;
                    case 'last_month':
                        fromDate = new Date(today.getFullYear(), today.getMonth() - 1, 1).toISOString()
                            .split('T')[0];
                        toDate = new Date(today.getFullYear(), today.getMonth(), 0).toISOString().split(
                            'T')[0];
                        break;
                    case 'last_3_months':
            ...
            function updatePaginationInfo() {
                ...
                if (total === 0) {
                    $('#page-info').text('0 of 0');
                    $('#page-first, #page-prev, #page-next, #page-last').addClass('disabled');
                } else {
            ...
            function calculateTotal() {
                ...
                $('.qbo-table tbody .qbo-total-tr').remove();
                
                // Get all visible rows from the table DOM (excluding previously added total row)
                $('.qbo-table tbody tr:not(.qbo-total-tr)').each(function() {
                    // Total is in the 7th column (0-indexed: 6)
                    var $totalCell = $(this).find('td').eq(6);
                    if ($totalCell.length) {
                        // Get the text content, removing HTML tags
                        var text = $totalCell.text().trim();
                        // Remove $ and commas, keep the minus sign
                        var cleanValue = text.replace(/[$,\s]/g, '');
                ...
                // Create and inject the total row into the table tbody
                // Columns: checkbox, date, type, no, payee, category, total, action (8 columns)
                var $totalRow = $(
                    '<tr class="qbo-total-tr">' +
                    '<td></td>' +                                                    // checkbox
                    '<td class="total-label">Total</td>' +                           // date -> shows "Total"
                    '<td></td>' +                                                    // type
                    '<td></td>' +                                                    // no
                    '<td></td>' +                                                    // payee
                    '<td></td>' +                                                    // category
                    '<td class="total-value">' + formatted + '</td>' +               // total
                    '<td></td>' +                                                    // action
                    '</tr>'
                );
                
                // Append the total row to tbody
                $('.qbo-table tbody').append($totalRow);
            }
            
            // Wait for table to be initialized
            setTimeout(function() {
                table = window.LaravelDataTables['vendor-transactions-table'];
                if (table) {
            ...
            $('#page-first').on('click', function() {
                ...
                var t = window.LaravelDataTables['vendor-transactions-table'];
                if (t) t.page('first').draw('page');
            });
            
            $('#page-prev').on('click', function() {
                if ($(this).hasClass('disabled')) return;
                var t = window.LaravelDataTables['vendor-transactions-table'];
                if (t) t.page('previous').draw('page');
            });
            
            $('#page-next').on('click', function() {
                if ($(this).hasClass('disabled')) return;
                var t = window.LaravelDataTables['vendor-transactions-table'];
                if (t) t.page('next').draw('page');
            });
            
            $('#page-last').on('click', function() {
                if ($(this).hasClass('disabled')) return;
                var t = window.LaravelDataTables['vendor-transactions-table'];
                if (t) t.page('last').draw('page');
            });
        });
    </script>
    <script>
        $(function() {
            ...
            function createAttachmentInput() {
                var $input = $('<input type="file" class="single-attachment-input d-none" multiple>');
                ...
                $input.on('change', function() {
                    ...
                    // Check all files for size limit first
                    for (var i = 0; i < files.length; i++) {
                        if (files[i].size > maxFileSize) {
                            hasOversizedFile = true;
                            alert(files[i].name + ' is too large. Max file size is 20 MB');
                        }
                    }
                    ...
                    for (var j = 0; j < files.length; j++) {
                        ...
                        var rowId = 'att_' + Date.now() + '_' + Math.floor(Math.random() * 1000) + '_' + j;
                        ...
                        // For multiple files, we need to create a new DataTransfer to hold each file
                        // Create a new single-file input for this specific file
                        var $fileInput = $('<input type="file" class="single-attachment-input d-none">');
                        $fileInput.attr('name', 'attachments[' + rowId + ']');
                        
                        // Transfer this specific file to the new input using DataTransfer
                    ...
                    // We don't create a new input here since we reuse the same one
                });
            }
