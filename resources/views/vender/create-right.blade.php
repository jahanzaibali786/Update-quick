{{-- resources/views/vender/create-right.blade.php --}}
{{ Form::open(['url' => 'vender', 'method' => 'post', 'id' => 'venderForm', 'class' => 'customer-drawer-wrapper h-100 d-flex flex-column']) }}
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-6 mt-3 mt-md-4">
                                <div class="form-check">
                                    {{ Form::checkbox('track_payments_1099', 1, false, [
