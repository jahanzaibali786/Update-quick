...
<div class="row">
    <div class="d-flex justify-content-between align-items-center border-bottom"
        ...
        <div class="TrowserHeader d-flex align-items-center">
            ...
            <div class="TrowserHeader">
                <a href="{{route('purchase.index')}}" class="text-dark me-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" color="currentColor" width="24px" height="24px" focusable="false"
                        aria-hidden="true" class="">
                        <path fill="currentColor"
                ...
                <div class="row align-items-start">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="vendor_id" class="form-control select2" id="vendor_selector" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" name="mailing_address" id="vendor_address" rows="5" readonly style="background: #ffffff;"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <a href="#" class="text-primary small btn-link">Cc/Bcc</a>
                                        </div>
                                        <input type="email" name="vendor_email" id="vendor_email" class="form-control" placeholder="Separate emails with a comma">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select name="ship_to" class="form-control select2" id="ship_to">
                                        ...
                                        <label class="form-label mt-3">{{ __('Shipping address') }}</label>
                    ...
                    <div class="col-2 text-end">
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <p class="h3 mb-0 grand-total-display totalAmount" style="font-size:36px;font-weight:900;" id="grand-total-display">$0.00</p>
