                ...
                <div class="qbo-nav-row">
                    <div class="qbo-nav-container">
                        <a href="{{ route('transaction.bankTransactions') }}" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #1E88E5, #1565C0);"><img
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/accounting/1/0/0/accounting.svg"
                                    class="chip-icon" alt="" style="width: 28px;"></span>
                            <span>{{ __('Accounting') }}</span>
                        </a>
                        <a href="{{ route('expense.index') }}" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #43A047, #2E7D32);"><img
                                    style="width: 28px;"
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/expenses/1/0/0/expenses.svg"
                                    class="chip-icon" alt=""></span>
                            <span>{{ __('Expenses & Pay Bills') }}</span>
                        </a>
                        <a href="{{ route('invoice.overview') }}" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #00897B, #00695C);"><img
                                    style="width: 28px;"
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/sales-payments/1/0/0/sales-payments.svg"
                                    class="chip-icon" alt=""></span>
                            <span>{{ __('Sales & Get Paid') }}</span>
                        </a>
                        <a href="{{ route('customer.index') }}" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #00ACC1, #00838F);"><img
                                    style="width: 28px;"
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/customers/1/0/0/customers.svg"
                                    class="chip-icon" alt=""></span>
                            <span>{{ __('Customers') }}</span>
                        </a>
                        <a href="{{ route('user.index') }}" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #5E35B1, #4527A0);"><img
                                    style="width: 28px;"
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/team/1/0/0/team.svg"
                                    class="chip-icon" alt=""></span>
                            <span>{{ __('Team') }}</span>
                        </a>
                        <a href="" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #3949AB, #283593);"><img
                                    style="width: 28px;"
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/time/1/0/0/time.svg"
                                    class="chip-icon" alt=""></span>
                            <span>{{ __('Time') }}</span>
                        </a>
                        <a href="{{ route('productservice.index') }}" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #039BE5, #0277BD);"><img
                                    style="width: 28px;"
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/inventory/1/0/0/inventory.svg"
                                    class="chip-icon" alt=""></span>
                            <span>{{ __('Inventory') }}</span>
                        </a>
                        <a href="#" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #E53935, #C62828);"><img
                                    style="width: 28px;"
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/sales-tax/1/0/0/sales-tax.svg"
                                    class="chip-icon" alt=""></span>
                            <span>{{ __('Sales Tax') }}</span>
                        </a>
                        <a href="#" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #8E24AA, #6A1B9A);"><img
                                    style="width: 28px;"
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/business-tax/1/0/0/business-tax.svg"
                                    class="chip-icon" alt=""></span>
                        ...
                        <a href="#" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #8E24AA, #6A1B9A);"><img
                                    style="width: 28px;"
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/lending/1/0/0/lending.svg"
                                    class="chip-icon" alt=""></span>
                        ...
                        <a href="#" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #8E24AA, #6A1B9A);"><img
                                    style="width: 28px;"
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/payroll/1/0/0/payroll.svg"
                                    class="chip-icon" alt=""></span>
                            <span>{{ __('Payroll') }}</span>
                            <!-- premium svg -->
                            <span class="qbo-nav-premium"><svg width="20px" height="20px" viewBox="0 0 24 24"
                                    fill="none" xmlns="http://www.w3.org/2000/svg" focusable="false"
                                    aria-hidden="true">
                                    <path
                                        d="m21.782 9.375-4-5A1 1 0 0 0 17 4H7a1 1 0 0 0-.781.375l-4 5a1 1 0 0 0 .074 1.332l9 9a1 1 0 0 0 1.414 0l9-9a1 1 0 0 0 .075-1.332ZM18.92 9h-3.2l-1-3h1.8l2.4 3ZM8.28 11l1.433 4.3L5.414 11H8.28Zm5.333 0L12 15.839 10.387 11h3.226Zm-3.225-2 1-3h1.22l1 3h-3.22Zm5.333 2h2.865l-4.3 4.3 1.435-4.3Zm-8.24-5h1.8l-1 3h-3.2l2.4-3Z"
                        ...
                        <a href="#" class="qbo-nav-chip">
                            <span class="qbo-nav-icon" style="background: linear-gradient(135deg, #8E24AA, #6A1B9A);"><img
                                    style="width: 28px;"
                                    src="https://asset-service-cdn-prdasset-prd.a.intuit.com/navigationfusionga/marketing/1/0/0/marketing.svg"
                                    class="chip-icon" alt=""></span>
        ...
        <div class="qbo-scrollable-content">
            <div class="container-fluid">
                ...
                <div class="qbo-business-feed">
                    ...
                    <div class="qbo-feed-cards">
                        <div class="qbo-feed-card">
                            <div class="qbo-feed-card-header">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    aria-hidden="true" class="IglFFVfJjdri6o0yYcmONA==">
                                    <path fill="currentColor"
                                        d="M18.007 21.99H18l-12-.017a3 3 0 0 1-2.995-3l.022-14a3 3 0 0 1 3-3l12 .018a3 3 0 0 1 3 3l-.022 14a3 3 0 0 1-3 3zm0-2a1 1 0 0 0 1-1l.022-14a1 1 0 0 0-1-1l-12-.017a1 1 0 0 0-1 1l-.022 14a1 1 0 0 0 1 1z">
                                    </path>
                                    <path fill="currentColor"
                                        d="M10.027 6.979h-3a1 1 0 0 1 0-2h3a1 1 0 0 1 0 2M17.009 18.99h-3a1 1 0 1 1 0-2h3a1 1 0 1 1 0 2M16.025 7.988l-8-.012a2 2 0 0 0-2 2v3a2 2 0 0 0 2 2l5 .007h3a2 2 0 0 0 2-2v-3a2 2 0 0 0-2-1.995m-8 1.988 4 .006v3l-4-.006zm8 3.012h-2v-3h2z">
                                    </path>
                                </svg>
                                <span>{{ __('Overdue invoices') }}</span>
                                <button class="qbo-card-menu"><i class="ti ti-dots-vertical"></i></button>
                            </div>
                            <p class="qbo-feed-card-text">{{ \Auth::user()->priceFormat($overdueInvoicesTotal) }} worth of
                                invoice reminders are ready for you to review...</p>
                            <a href="{{ route('invoice.index') }}" class="qbo-feed-card-link">{{ __('Review all') }}
                                ({{ $overdueInvoicesCount }})</a>
                        </div>
                        <div class="qbo-feed-card">
                            <div class="qbo-feed-card-header">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    ...
                                    aria-hidden="true" class="IglFFVfJjdri6o0yYcmONA==">
                                    <path fill="currentColor"
                                        d="M20.988 8.939a1 1 0 0 0-.054-.265.973.973 0 0 0-.224-.374v-.005l-6-6a1 1 0 0 0-.283-.191c-.031-.014-.064-.022-.1-.034a1 1 0 0 0-.259-.052C14.042 2.011 14.023 2 14 2H6a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3V9c0-.022-.011-.04-.012-.061M15 5.414 17.586 8H16a1 1 0 0 1-1-1zM18 20H6a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1h7v3a3 3 0 0 0 3 3h3v9a1 1 0 0 1-1 1">
                                    </path>
                                    <path fill="currentColor"
                                        d="M7 10h3a1 1 0 1 0 0-2H7a1 1 0 0 0 0 2M14 13H7a1 1 0 0 0 0 2h7a1 1 0 0 0 0-2M14 16H7a1 1 0 0 0 0 2h7a1 1 0 0 0 0-2">
                                    </path>
                                </svg>
                                <span>{{ __('Profit and loss') }}</span>
                                <button class="qbo-card-menu"><i class="ti ti-dots-vertical"></i></button>
                            </div>
                            <p class="qbo-feed-card-text">{{ __('Your net profit for') }} {{ now()->format('F') }}
                                {{ __('was') }} {{ \Auth::user()->priceFormat($netProfitThisMonth) }}.</p>
                            <a href="{{ route('report.profit.loss') }}"
                                class="qbo-feed-card-link">{{ __('View full report') }}</a>
                        </div>
                        <div class="qbo-feed-card qbo-feed-card-highlight">
                            <div class="qbo-feed-card-header">
                                <button class="qbo-card-menu"><i class="ti ti-dots-vertical"></i></button>
                            </div>
                            <p class="qbo-feed-card-text">{{ __('Autofilling expenses keeps your records organized') }}
                            </p>
                        ...
                        <div class="qbo-feed-card">
                            ...
                            <p class="qbo-feed-card-text">{{ \Auth::user()->priceFormat($paymentsThisWeek) }} in payments
                                were made this week</p>
                            <a href="{{ route('payment.index') }}"
                                class="qbo-feed-card-link">{{ __('Go to payments') }}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="qbo-create-actions">
                    ...
                    <a href="{{ route('expense.index') }}" class="qbo-create-action-btn">{{ __('Record expense') }}</a>
                        ...
                        <div class="col-12">
                            ...
                            <div class="grid-stack" id="dashboard-grid">
                                @foreach ($widgets as $widget)
                                    @if (isset($widgetDefs[$widget->key]))
                                        <div class="grid-stack-item" gs-id="{{ $widget->id }}"
                                            data-widget-key="{{ $widget->key }}" gs-x="{{ $widget->x }}"
                                            gs-y="{{ $widget->y }}" gs-w="{{ $widget->w }}"
                                            gs-h="{{ $widget->h }}" gs-min-w="2" gs-min-h="1">
                                            <div class="grid-stack-item-content">
                                                ...
                                                <div class="qbo-edit-overlay">
                                                    ...
                                                    <div class="qbo-move-container">
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            ...
                                                            class="qbo-arrow-up">
                                                            <path fill="currentColor"
                                                                d="m19.8 11.394-7.06-7.082a1 1 0 0 0-1.414 0L4.241 11.37a1 1 0 0 0 1.412 1.416l5.372-5.356-.018 11.586a1 1 0 1 0 2 0l.018-11.587 5.356 5.373a1 1 0 0 0 1.419-1.41">
                                                            </path>
                                                        </svg>
                                                        {{-- Arrow Right --}}
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" width="24px" height="24px"
                                                            class="qbo-arrow-right">
                                                            <path fill="currentColor"
                                                                d="m19.726 11.287-7.061-7.082a1 1 0 1 0-1.416 1.412l5.356 5.372-11.585-.017a1 1 0 1 0 0 2l11.586.017-5.376 5.356a1 1 0 1 0 1.412 1.416l7.082-7.06a1 1 0 0 0 0-1.414z">
                                                            </path>
                                                        </svg>
                                                        {{-- Arrow Down --}}
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" width="24px" height="24px"
                                                            class="qbo-arrow-down">
                                                            <path fill="currentColor"
                                                                d="M19.761 11.251a1 1 0 0 0-1.414 0l-5.371 5.355.016-11.586a1 1 0 0 0-2 0l-.016 11.58-5.357-5.37A1.001 1.001 0 0 0 4.2 12.643l7.061 7.081a1 1 0 0 0 1.413.002l7.081-7.06a1 1 0 0 0 .006-1.415">
                                                            </path>
                                                        </svg>
                                                        {{-- Arrow Left --}}
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" width="24px" height="24px"
                                                            class="qbo-arrow-left">
                                                            <path fill="currentColor"
                                                                d="M19.02 11.028 7.435 11.01l5.371-5.355a1 1 0 0 0-1.412-1.416L4.312 11.3a1 1 0 0 0 0 1.414L11.37 19.8a1 1 0 1 0 1.416-1.412L7.429 13.01l11.587.018a1 1 0 1 0 0-2z">
                                                            </path>
                                                        </svg>
                                                        <div class="qbo-move-tooltip">
                                                            {{ __('To move a tile, select and drag it to a new spot.') }}
                                                        </div>
                                                    </div>

                                                    {{-- Delete Button --}}
                                                    <div class="qbo-delete-container"
                                                        data-widget-id="{{ $widget->id }}">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" width="20px" height="24px">
                                                            <path fill="currentColor"
                                                                d="m21.011 5.013-5-.007v-2a2 2 0 0 0-2-2l-4-.006a2 2 0 0 0-2 2v2h-5a1 1 0 0 0 0 2h1l-.019 13a3 3 0 0 0 2.995 3l10 .016a3 3 0 0 0 3-3l.019-13h1a1 1 0 1 0 0-2zM10.013 3l4 .006v2h-4zm7.975 17.012a1 1 0 0 1-1 1l-10-.016a1 1 0 0 1-1-1l.019-13 6 .009h6z">
                                                            </path>
                                                            <path fill="currentColor"
                                                                d="M15 9.005a1 1 0 0 0-1 1l-.012 8a1 1 0 0 0 2 0l.012-8a1 1 0 0 0-1-1">
                                                            </path>
                                                        </svg>
                                                ...
                                                <div class="qbo-widget-card">
                                                    <div class="qbo-widget-header">
                                                        <span
                                                            class="qbo-widget-title">{{ $widgetDefs[$widget->key]['name'] }}</span>
                                                    </div>
                                ...
                                @php
                                    ...
                                    $addWidgetY = $maxY + 1;
                                @endphp
                                <div class="grid-stack-item qbo-add-widget-card" gs-x="0"
                                    gs-y="{{ $addWidgetY }}" gs-w="3" gs-h="1" gs-min-w="2"
                                    gs-min-h="1" gs-id="add-widget">
                                    <div class="grid-stack-item-content">
                                        ...
                                        <div class="qbo-edit-overlay qbo-no-delete">
                                            ...
                                            <div class="qbo-move-container">
                                                ...
                                                <div class="qbo-move-tooltip">
                                                    {{ __('To move a tile, select and drag it to a new spot.') }}</div>
                                            </div>
                                        </div>

                                        {{-- Add Widget Content --}}
                                        <div class="qbo-add-widget-content" data-bs-toggle="modal"
                                            data-bs-target="#addWidgetsModal">
                                            ...
                                            <div class="qbo-suggestions-section">
                                                ...
                                                <p class="qbo-suggestions-text">
                                                    {{ __('Nothing new here yet. Check back later for new suggestions.') }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal fade" id="addWidgetsModal" tabindex="-1" aria-labelledby="addWidgetsModalLabel"
                    aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="qbo-widget-list">
                                    @foreach (config('dashboard.widgets') as $key => $def)
                                        @php
                                            $isEnabled =
                                                $widgets->where('key', $key)->where('enabled', true)->count() > 0;
                                        @endphp
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary"
                                    id="saveWidgetSelection">{{ __('Save') }}</button>
                            </div>
                        </div>
                    </div>
                </div>
