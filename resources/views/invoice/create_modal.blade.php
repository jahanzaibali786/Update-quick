                        ...
                        <div class="header-bottom-row">
                            <div class="nav-tabs-custom">
                                <button type="button" style="padding: 10px;"
                                    class="nav-tab active">{{ __('Edit') }}</button>
                                <button type="button" style="padding: 10px;"
                                    class="nav-tab">{{ __('Email view') }}</button>
                                <button type="button" style="padding: 10px;"
                                    class="nav-tab">{{ __('Payor view') }}</button>
                                <button type="button" style="padding: 10px;" class="nav-tab">{{ __('PDF view') }}</button>
                            </div>
            ...
            $(document).on('click', '.suggestion-add-button', function() {
                ...
                if (p.items && p.items.length) {
                    p.items.forEach(function(item) {
                        insertProposalItem(item, $insertBefore);
                    });
                } else {
