                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            ...
                            if (typeof show_toastr === 'function') {
                                show_toastr('success',
                                    '{{ __('Expense Update Successfully') }}', 'success');
                            }
        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="row">
                    <div class="d-flex justify-content-between align-items-center border-bottom"
                        ...
                        <div class="TrowserHeader d-flex align-items-center">
                            ...
                            <div class="TrowserHeader">
                                <a href="#" class="text-dark me-2"><svg xmlns="http://www.w3.org/2000/svg"
                                        fill="none" viewBox="0 0 24 24" color="currentColor" width="24px"
                                        height="24px" focusable="false" aria-hidden="true" class="">
                                        <path fill="currentColor"
                    ...
                    {{ Form::model($bill, ['route' => ['bill.update', $bill->id], 'method' => 'PUT', 'class' => 'w-100', 'style' => 'padding: 30px 30px; background: #ffffff;', 'id' => 'bill-form']) }}
                    <div class="col-12">
                                ...
                                <div class="bill-header-section">
                                    ...
                                    <div class="bill-header-top">
                                        ...
                                        <div class="bill-balance-col">
                                            ...
                                            <div class="bill-balance-amount grand-total-display">
                                                {{ \Auth::user()->priceFormat($bill->total) }}</div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="bill-details-section">
                                            ...
                                            <div class="bill-field-group bill-date-field">
                                                ...
                                                <input type="date" name="bill_date" id="bill_date"
                                                    class="form-control" required value="{{ $bill->bill_date }}">
                                            </div>
                                            <div class="bill-field-group bill-date-field">
                                                <label>{{ __('Due date') }}</label>
                                                <input type="date" name="due_date" id="due_date"
                                                    class="form-control" required value="{{ $bill->due_date }}">
                                            </div>
                                    ...
                                    <div class="bill-toggle-row">
                                        <button type="button" class="bill-toggle-btn" id="billToggleBtn"
                        ...
                        <div class="col-12">
                            <div class="custom-accordion">
                                <div class="accordion-header d-flex " onclick="toggleAccordion(this)">
                                    <div class="accordion-arrow" onclick="toggleAccordion(this)"><svg
                                            xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            color="currentColor" width="24px" height="24px" focusable="false"
                                            aria-hidden="true"
                                        ...
                                        <div class="toolbar-buttons">
                                            ...
                                            <button class="toolbar-btn" type="button" title="Export to Excel">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    ...
                                                    height="20px" focusable="false" aria-hidden="true" class="">
                                                    <path fill="currentColor"
                                            ...
                                            <button class="toolbar-btn" type="button" title="Column Settings">
                                                <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24"
                                                    class="" width="20px" height="20px" fill="currentColor">
                                                    <path
                                                        d="M12.024 7.982h-.007a4 4 0 100 8 4 4 0 10.007-8zm-.006 6a2 2 0 01.002-4 2 2 0 110 4h-.002z">
                                                    </path>
                                                    <path
                                                ...
                                                <table class="table align-middle" id="category-table">
                                                    <thead class="table-light">
                                                        <tr>
                                                            ...
                                                            <th width="5%" class="text-center">{{ __('BILLABLE') }}
                                                            </th>
                                                            <th width="5%" class="text-center">{{ __('TAX') }}
                                                            </th>
                ...
                ">Clear</button>
                        ...
                        <div class="footer-right d-flex align-items-center gap-2">
                            ...
                            <div class="btn-group">
                                ...
                                <button type="button"
                                    class="btn btn-success btn-sm-qbo dropdown-toggle dropdown-toggle-split"
