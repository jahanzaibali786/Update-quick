    ...
    <nav class="qbo-header-nav" aria-label="Tools">
            ...
            <div class="qbo-header-item">
                <a href="{{ route('dashboard') }}" class="qbo-app-logo" aria-label="Dashboard">
                    <div class="qbo-logo-wrapper">
                        {{-- QBO Ball Logo SVG --}}
                        <svg class="qbo-logo-icon" width="32" height="32" viewBox="0 0 40 40" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect width="40" height="40" rx="4" fill="#2CA01C" />
                            <path
                                d="M20 8C13.373 8 8 13.373 8 20C8 26.627 13.373 32 20 32C26.627 32 32 26.627 32 20C32 13.373 26.627 8 20 8ZM24.5 25C24.5 25.828 23.828 26.5 23 26.5H17C16.172 26.5 15.5 25.828 15.5 25V15C15.5 14.172 16.172 13.5 17 13.5H23C23.828 13.5 24.5 14.172 24.5 15V25Z"
                                fill="white" />
                        </svg>
                        {{-- Company Logo Image --}}
                        <img src="{{ asset(Storage::url('uploads/logo/')) }}/{{ $company_logo }}"
                            alt="{{ $company_name }}" class="qbo-logo-img">
                    </div>
                </a>
            </div>
            ...
            <div class="qbo-header-item">
                <div class="qbo-global-search-container" role="search">
                    <div class="qbo-search-input-wrapper">
                        ...
                        <svg class="qbo-search-icon" width="20" height="20" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path
                                d="m21.694 20.307-6.239-6.258A7.495 7.495 0 0 0 9.515 2H9.5a7.5 7.5 0 1 0 4.535 13.465l6.24 6.259a1.001 1.001 0 0 0 1.416-1.413l.003-.004ZM5.609 13.38A5.5 5.5 0 0 1 9.5 4h.009a5.5 5.5 0 1 1-3.9 9.384v-.004Z"
                                fill="currentColor"></path>
                        </svg>
                        <input type="search" id="qboGlobalSearch" class="qbo-search-input"
        ...
        <div class="qbo-header-container qbo-container-right">
            ...
            <div class="qbo-header-item">
                <button type="button" class="qbo-header-item-button qbo-oia-btn" title="Intuit account">
                    <span class="qbo-avatar qbo-avatar-alert">
                        @if (Auth::user()->avatar)
                            <img src="{{ asset(Storage::url('uploads/avatar/')) }}/{{ Auth::user()->avatar }}"
                                alt="Avatar">
                        @else
            ...
            <div class="qbo-header-item" title="QB Assistant">
                <button class="qbo-header-item-button" aria-label="QB Assistant">
                    ...
                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg" color="#6b6c72" focusable="false" aria-hidden="true"
                        class="global-header-item-icon">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M11 2a3 3 0 0 1 3 3v6a3 3 0 0 1-3 3H9v2a1 1 0 0 0 1 1h1a3 3 0 0 1 3-3h5a3 3 0 0 1 3 3v2a3 3 0 0 1-3 3h-5a3 3 0 0 1-3-3h-1a3 3 0 0 1-3-3v-2H5a3 3 0 0 1-3-3V5a3 3 0 0 1 3-3h6Zm3 14a1 1 0 0 0-1 1v2a1 1 0 0 0 .898.995L14 20h5l.102-.005a1 1 0 0 0 .893-.893L20 19v-2a1 1 0 0 0-1-1h-5ZM5 4a1 1 0 0 0-1 1v6a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1H5Z"
                            fill="currentColor"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M19 4a3 3 0 0 1 3 3v3a3 3 0 0 1-3 3h-1a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3h1Zm-1 2a1 1 0 0 0-1 1v3l.005.102a1 1 0 0 0 .893.893L18 11h1l.102-.005A1 1 0 0 0 20 10V7a1 1 0 0 0-1-1h-1Z"
                            fill="currentColor"></path>
                    </svg>
                </button>
            </div>
            ...
            <div class="qbo-header-item" title="Notifications">
                <button class="qbo-header-item-button qbo-notifications-btn" data-bs-toggle="dropdown"
                    aria-expanded="false" aria-label="Notifications">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg" class="qbo-header-item-icon">
                        <path
                            ...
                            @foreach ($notifications as $notification)
                                <a href="#" class="qbo-notification-item">
                                    ...
                                    <div class="qbo-notification-content">
                                        ...
                                        <span
                                            class="qbo-notification-time">{{ $notification->created_at->diffForHumans() }}</span>
                                    </div>
                                </a>
                            @endforeach
                        @else
            ...
            <div class="qbo-mega-settings" id="qboMegaSettings" role="dialog" aria-label="Settings Menu">
                ...
                <div class="qbo-mega-body">
                    ...
                    {{-- Column 2: LISTS --}}
                    <div class="qbo-mega-column">
                        <h6 class="qbo-mega-column-title">LISTS</h6>
                        <ul class="qbo-mega-list">
                            <li><a href="#">All lists</a></li>
                            <li><a href="{{ route('productservice.index') }}">Products and services</a></li>
                    ...
                    {{-- Column 3: TOOLS --}}
                    <div class="qbo-mega-column">
                        <h6 class="qbo-mega-column-title">TOOLS</h6>
                        <ul class="qbo-mega-list">
                            <li><a href="#">Manage workflows</a></li>
                            <li><a href="#">Reclassify transactions</a></li>
                            <li><a href="#">Order checks</a></li>
                            <li><a href="#">Import data</a></li>
                            <li><a href="#">Import desktop data</a></li>
                            <li><a href="#">Export data</a></li>
                            <li><a href="#">Reconcile</a></li>
                            <li><a href="#">Budgeting</a></li>
                            <li><a href="#">Spreadsheet Sync</a></li>
                            <li><a href="#">Audit log</a></li>
                            <li><a href="#">Back up company</a></li>
                            <li><a href="#">Share screen</a></li>
                            <li><a href="#">Resolution center</a></li>
                        </ul>
                    </div>
                    {{-- Column 4: PROFILE --}}
                    <div class="qbo-mega-column">
                        <h6 class="qbo-mega-column-title">PROFILE</h6>
                        <ul class="qbo-mega-list">
                            <li><a href="#">Subscriptions and billing</a></li>
                ...
                <button type="button" class="qbo-header-item-button" aria-label="Help">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <path
                            ...
                            fill="currentColor" />
                        <path
                            d="M12.5 7.09c.18.04.34.1.48.19.14.09.27.19.38.32.11.13.19.27.25.43.06.15.09.32.09.49 0 .28-.07.53-.21.74-.14.21-.35.4-.63.57-.14.08-.25.18-.33.28-.08.1-.14.21-.17.33-.03.11-.04.23-.04.35v.41h-1.64v-.55c0-.26.04-.49.12-.7.08-.21.19-.38.33-.53.14-.15.3-.28.48-.39.16-.09.29-.2.38-.32.09-.12.14-.27.14-.45 0-.14-.03-.27-.1-.37-.07-.1-.15-.19-.24-.25-.1-.06-.2-.11-.32-.14-.12-.03-.23-.04-.34-.04-.27 0-.5.06-.7.19-.2.13-.38.3-.54.51l-1.17-.88c.26-.38.59-.68.99-.89.4-.21.88-.31 1.44-.31.28 0 .55.04.82.11zm-1.63 5.73h1.64v1.64h-1.64v-1.64z"
                            fill="currentColor" />
                    </svg>
                </button>
            </div>
            ...
            <div class="qbo-header-item">
                <button type="button" class="qbo-header-item-button qbo-user-profile-btn" data-bs-toggle="dropdown"
...
<style>
    ...
    .qbo-mega-column:last-child {
        border-right: none;
    }

    .qbo-mega-column-title {
        font-size: 11px;
        font-weight: 700;
        text-transform: uppercase;
    ...
    @media (max-width: 992px) {
        ...
        .qbo-mega-column:nth-child(odd) {
            border-right: 1px solid #f0f0f0;
        }

        .qbo-mega-column:nth-last-child(-n+2) {
            border-bottom: none;
            margin-bottom: 0;
            padding-bottom: 0;
        }
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function renderResults(data, query) {
            ...
            if (data.length > 0) {
                ...
                if (aiAnswers.length > 0) {
                    html +=
                        '<div class="qbo-search-header">AI Answer <span class="qbo-ai-badge"><i class="ti ti-sparkles"></i> AI</span></div>';
        ...
        if (searchInput) {
                ...
                if (query.length < 2) {
                    ...
                    if (recentData) {
                        ...
                        resultsContainer.innerHTML =
                            '<div class="qbo-search-loading"><i class="ti ti-loader"></i> Loading...</div>';
                        resultsContainer.classList.add('show');
                        ...
                        fetch('{{ route('global.search.recent') }}')
                            ...
                            .catch(error => {
                                ...
                                resultsContainer.innerHTML =
                                    '<div class="qbo-search-empty">Unable to load recent transactions</div>';
                            });
                    } else if (recentData) {
                        resultsContainer.innerHTML = renderRecent(recentData);
                        resultsContainer.classList.add('show');
            ...
            searchInput.addEventListener('input', function() {
                ...
                searchTimeout = setTimeout(() => {
                    resultsContainer.innerHTML =
                        '<div class="qbo-search-loading"><i class="ti ti-loader"></i> Searching...</div>';
                    resultsContainer.classList.add('show');
                    ...
                    fetch(`{{ route('global.search') }}?query=${encodeURIComponent(query)}`)
                        ...
                        .catch(error => {
                            ...
                            resultsContainer.innerHTML =
                                '<div class="qbo-search-empty">Error loading results</div>';
                            resultsContainer.classList.add('show');
                        });
                }, 300);
            });
        ...
        // ====== Mega Settings Dropdown ======
        const settingsBtn = document.getElementById('qboSettingsBtn');
        const megaPanel = document.getElementById('qboMegaSettings');
        const megaOverlay = document.getElementById('qboMegaOverlay');
        const megaClose = document.getElementById('qboMegaClose');

        function openMegaSettings() {
            megaOverlay.classList.add('show');
            megaPanel.style.display = 'block';
            // trigger reflow so the CSS transition fires
            void megaPanel.offsetHeight;
            megaPanel.classList.add('show');
            settingsBtn.setAttribute('aria-expanded', 'true');
        }

        function closeMegaSettings() {
            megaPanel.classList.remove('show');
            megaOverlay.classList.remove('show');
            settingsBtn.setAttribute('aria-expanded', 'false');
            // hide after animation
            setTimeout(function() {
                if (!megaPanel.classList.contains('show')) {
        ...
        if (megaClose) {
            megaClose.addEventListener('click', closeMegaSettings);
        }

        if (megaOverlay) {
            megaOverlay.addEventListener('click', closeMegaSettings);
        }

        // ESC to close mega settings
        document.addEventListener('keydown', function(e) {
            if (e.key === 'Escape' && megaPanel && megaPanel.classList.contains('show')) {
                closeMegaSettings();
            }
        });
    });
