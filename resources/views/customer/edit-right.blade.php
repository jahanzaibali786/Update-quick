...
{{ Form::model($customer, ['route' => ['customer.update', $customer->id], 'method' => 'PUT', 'id' => 'customerForm', 'class' => 'customer-drawer-wrapper h-100 d-flex flex-column']) }}
    ...
    <div class="d-flex align-items-center gap-2">
        ...
        <button type="button" class="customer-nav-btn" data-target="#sec-payments" title="{{ __('Payments') }}">
            <svg aria-hidden="true" focusable="false" viewBox="0 0 24 24" class="" width="24px" height="24px"
                fill="currentColor">
                <path
                    d="M21.133 4.892a2.982 2.982 0 00-2.12-.882l-14-.02h-.005a3 3 0 00-3 3l-.015 10a3 3 0 003 3h2a1 1 0 100-2h-2a1 1 0 01-1-1l.009-6 16 .024-.009 6a1 1 0 01-1 1h-2a1 1 0 000 2H19a3 3 0 003-3l.015-10a2.981 2.981 0 00-.882-2.122zM4.006 8.988v-2a1 1 0 011-1l14 .02a1 1 0 011 1v2l-16-.02z">
                </path>
                <path
                    d="M15.707 15.293a1 1 0 00-1.414 0L12 17.586l-.793-.793a1 1 0 00-1.414 1.414l1.5 1.5a1 1 0 001.414 0l3-3a1 1 0 000-1.414z">
                </path>
            </svg>
        </button>
                ...
                <div id="collapse-basic" class="accordion-collapse collapse show" aria-labelledby="heading-basic">
                    <div class="accordion-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6 d-flex align-items-end">
                                <div class="form-check mt-3">
                                    {{ Form::checkbox('is_sub_customer', 1, null, [
                                        'class' => 'form-check-input',
                                        'id' => 'is_sub_customer',
                                    ]) }}
                                    <label class="form-check-label" for="is_sub_customer">
                        ...
                        @if (App\Models\Utility::getValByName('shipping_display') == 'on')
                            ...
                            <div class="d-flex flex-column justify-content-between gap-4 mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="shipping_same_as_billing">
            ...
            <div id="sec-payments" class="accordion-item customer-section mb-3">
                <h2 class="accordion-header" id="heading-payments">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        ...
                        </svg><span style="padding-left:10px;"> {{ __('Payments') }} </span>
                    </button>
                </h2>
            ...
            <div id="sec-additional" class="accordion-item customer-section mb-3">
                <h2 class="accordion-header" id="heading-additional">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        ...
                        <i class="ti ti-file-description me-2"></i><span style="padding-left:10px;">
                ...
                <div id="collapse-additional" class="accordion-collapse collapse show"
                    ...
                    <div class="accordion-body">
                        ...
                        <div class="row g-3 mt-1 align-items-end">
                            <div class="col-md-12">
                                <div class="form-check">
                                    {{ Form::checkbox('is_taxable', 1, null, [
                                        'class' => 'form-check-input',
                                        'id' => 'is_taxable',
                                    ]) }}
            ...
            <div id="sec-custom-fields" class="accordion-item customer-section mb-3">
                <h2 class="accordion-header" id="heading-custom-fields">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        ...
                        </svg><span style="padding-left:10px;"> {{ __('Custom fields') }} </span>
                    </button>
                </h2>
        ...
        $('.customer-drawer-body').on('scroll', function() {
            ...
            scrollTimeout = setTimeout(function() {
                ...
                $('.customer-section').each(function() {
                    ...
                    containerTop; // Distance from top of container viewport
