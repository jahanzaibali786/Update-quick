...
<div class="row">
    ...
    {{ Form::open(['url' => 'expense', 'class' => 'w-100', 'style' => 'padding: 30px 30px; background: #ffffff;', 'id' => 'bill-form']) }}
    <div class="col-12">
                                ...
                                <div class="form-group">
                                    <div class="d-flex flex-column">
                                        <label for="ref_no" class="qb-label" style="margin-bottom: 5px;">Ref
                                            no.</label>
                                        <input type="text" name="reference_no" id="ref_no" class="form-control qb-input w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
