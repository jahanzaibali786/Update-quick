...
<script>
    $(document).on('change', '#vender_id', function() {
        ...
        // Clear mailing address if no vendor selected
        if (!id || id === '__add__') {
            $('#mailing_address').val('');
            return;
        }
...
<div class="row">
    ...
    {{ Form::open(['route' => 'vendor-credit.store', 'class' => 'w-100', 'style' => 'padding: 30px 30px; background: #ffffff;', 'id' => 'vendor-credit-form']) }}
    <div class="col-12">
                ...
                <div class="row align-items-start">
                    ...
                    <div class="col-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3 form-group mb-3">
                                ...
                                <textarea id="mailing_address" name="mailing_address" class="form-control" rows="4" readonly placeholder=""></textarea>
                            </div>

                            {{-- Payment Date --}}
                            <div class="col-2 form-group mb-3">
                                <label for="date" class="form-label">{{ __('Payment date') }}</label>
                                {{ Form::date('date', date('Y-m-d'), ['class' => 'form-control', 'required' => 'required', 'id' => 'date']) }}
                            </div>
                    ...
                    <div class="col-2 text-end">
                        <div class="d-flex flex-column align-items-end">
                            ...
                            <p class="h3 mb-0 grand-total-display" style="font-size:36px;font-weight:900;color:#2ca01c;">$0.00</p>
                        </div>
                    </div>
                </div>
