...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('expense.index') }}">{{ __('Checks') }}</a></li>
    <li class="breadcrumb-item">{{ __('Checks Edit') }}</li>
@endsection
                    ...
                    success: function(response) {
                        if (response.success || response.status === 'success') {
                            ...
                            if (typeof show_toastr === 'function') {
                                show_toastr('success', response.success || response.message ||
                                    '{{ __('Check updated successfully') }}', 'success');
                            }
                            const CHECKS_URL = "{{ url('/expense') }}";
                            setTimeout(() => {
                                window.location.href = CHECKS_URL;
                            }, 500);
                        } else {
                            show_toastr('error', response.error || response.message ||
                                '{{ __('Error updating check') }}', 'error');
                ...
                <div class="row">
                    <div class="d-flex justify-content-between align-items-center border-bottom"
                        ...
                        <div class="TrowserHeader d-flex align-items-center">
                            ...
                            <h5 class="mb-0" style="font-size: 1.2rem;">Checks</h5>
                        </div>
                        <div class="TrowserHeader d-flex align-items-center">
                    ...
                    {{ Form::open(['route' => ['checks.update', $expense->id], 'method' => 'POST', 'class' => 'w-100', 'style' => 'padding: 30px 30px; background: #ffffff;', 'id' => 'bill-form']) }}
                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 form-group mb-3">
                                                <div class="row">
                                                    <div class="col-3">
                                                        <label for="payee_all"
                                                            class="form-label">{{ __('Payee') }}</label>

                                                        <select id="payee_all" name="payee" class="form-control select"
                                                            required data-selected-payee="{{ $selected_payee ?? '' }}">
                                    ...
                                    <div class="col-2 text-end" style="margin-top: -34px;">
                                        <div class="d-flex flex-column align-items-end">
                                            ...
                                            <p class="h3 mb-0 grand-total-display"
                                                style="font-size:36px;font-weight:900;"=>$0.00</p>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <div class="d-flex flex-column">
                                                        <label for="ref_no" class="qb-label"
                                                            style="margin-bottom: 5px;">Ref
                                                            no.</label>
                                                        <input type="text" id="ref_no" name="reference_no"
                                                            value="{{ $expense->ref_number }}"
                                                            class="form-control qb-input w-100">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <span class="text-muted me-2 drag-handle"
                                                                            style="cursor: move; font-size: 18px;"><svg
                                                                                ...
                                                                                color="#babec5" width="16px"
                                                                                height="16px" focusable="false"
                                                                                aria-hidden="true"
                                                                                data-testid="nine-dots-account-line-2">
                                                                                <path fill="currentColor"
                                                                                    d="m10.636 4.565-.07.071a1.93 1.93 0 0 0 0 2.728l.07.07a1.93 1.93 0 0 0 2.728 0l.07-.07a1.93 1.93 0 0 0 0-2.728l-.07-.07a1.93 1.93 0 0 0-2.728 0">
