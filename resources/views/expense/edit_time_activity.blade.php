    ...
    <div class="modal fade" id="time-activity-modal" tabindex="-1" aria-labelledby="timeActivityModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                ...
                <div class="modal-body qbo-modal-body"
                            ...
                            <div class="card shadow-none border-0 qbo-card">
                                <div class="card-body qbo-card-body">
                                    <div class="row qbo-row">
                                        ...
                                        <style>
                                            /* Right column time section max 70% like QBO */
                                            .time-section-70 {
                                                width: 70%;
                                                max-width: 70%;
                                            }
                                        ...
                                        <div class="col-md-6 qbo-right-column">
                                            ...
                                            <div class="time-section-70 qbo-time-section">
                                                ...
                                                <div class="row qbo-time-inputs-row" id="time_inputs"
                                                    ...
                                                    <div class="col-md-12">
                                                        <button type="button"
                                                            class="btn btn-sm btn-outline-primary qbo-add-break-btn"
                                                            id="add_break">
                                                            {{ __('Add break') }}
                                                        </button>
                                            ...
                                            <div class="form-group qbo-form-group qbo-summary-group" id="summary_section"
                                                style="display: none;">
                                                <p id="summary_text"
                                                    style="color: #00892E; font-weight: 600; font-size: 14px; margin-bottom: 0;">
                                                </p>
                                            </div>
                    ...
                    ">Save</button>
                                        <div class="btn-group">
                                            <button type="submit" class="btn btn-success btn-sm-qbo"
                                                style="padding: 6px 22px !important;">{{ __('Save and close') }}</button>
                                            <button type="button" style="padding: 7px 10px !important;"
    ...
    <script>
        $(document).ready(function() {
            ...
            function calculateTotal() {
                ...
                var isTaxable = $('#taxable').is(':checked');

                if (!durationVal || !isBillable || rate <= 0) {
                ...
                var durationParts = durationVal.split(':');
                ...
                var hoursText = hours > 0 ? hours + ' hour' + (hours !== 1 ? 's' : '') : '';
                var minutesText = minutes > 0 ? minutes + ' minute' + (minutes !== 1 ? 's' : '') : '';
                var durationText = hoursText + (hoursText && minutesText ? ' ' : '') + minutesText;

                var taxText = isTaxable ? ' plus tax' : '';
                var summaryText = 'Summary: ' + durationText + ' at $' + rate.toFixed(2) + ' per hour = $' +
                    totalAmount.toFixed(2) + taxText;
            ...
            // Bind calculateTotal to relevant field changes
            $('#duration, #rate, #billable, #taxable').on('change keyup', calculateTotal);

            // Also recalculate when duration is updated from start/end times
            $('#start_time, #end_time, #break_duration').on('change', function() {
                calculateDuration();
                calculateTotal();
            });
