                        ...
                        <table class="table datatable">
                            ...
                            @foreach ($categories as $category)
                                <tr>
                                    ...
                                    <td class="font-style">
                                        {{-- @dd(\App\Models\ProductServiceCategory::$catTypes) --}}
                                        {{-- @dd($categories) --}}
                                    ...
                                    <td class="Action">
                                        ...
                                        @can('edit constant category')
                                                <div class="action-btn bg-primary ms-2">
                                                    <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="{{ route('product-category.edit',$category->id) }}" data-ajax-popup="true" data-title="{{__('Edit Category')}}" data-bs-toggle="tooltip" title="{{__('Create')}}" data-original-title="{{__('Edit')}}">
