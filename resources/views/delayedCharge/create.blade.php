                ...
                <table class="product-table" id="items-table">
                    ...
                    <tbody id="items-body">
                        ...
                        <tr class="item-row">
                            ...
                            <td>
                                {{ Form::select('items[1][item]', $product_services, '', [
                                    'class' => 'form-select item-select',
                                    'placeholder' => 'Select a product/service',
                                ]) }}
                            </td>
                            <td>
                                {{ Form::textarea('items[1][description]', null, [
                                    'class' => 'form-control item-description',
                                    'rows' => '1',
                                    'placeholder' => '',
                                ]) }}
                            ...
                            <td>
                                {{ Form::text('items[1][quantity]', '', [
                                    'class' => 'form-control input-right item-quantity',
                                    'placeholder' => '',
                                ]) }}
                            </td>
                            <td>
                                {{ Form::text('items[1][price]', '', [
                                    'class' => 'form-control input-right item-price',
                                    'placeholder' => '',
                                ]) }}
                            </td>
                            <td>
                                <input type="text" name="items[1][amount]" class="form-control input-right item-amount" value="0.00" readonly>
                            </td>
                            <td>
                                <div class="form-check">
                                    <input class="form-check-input item-tax" type="checkbox" name="items[1][tax]" value="1">
                                </div>
                            </td>
                            <td>
                                <span class="delete-icon delete-row" title="Delete line">
        ...
        <div class="dc-footer">
            ...
            <div class="footer-actions">
                <div class="btn-group dropup">
                    <button type="submit" class="btn btn-primary">{{ __('Save and new') }}</button>
            ...
            $('#add-line').on('click', function() {
                var newRow = `
                    <tr class="item-row">
                        ...
                        <td>
                            <textarea name="items[${rowIndex}][description]" class="form-control item-description" rows="1"></textarea>
                        </td>
                        <td>
                            <input type="text" name="items[${rowIndex}][quantity]" class="form-control input-right item-quantity">
                        </td>
                        <td>
                            <input type="text" name="items[${rowIndex}][price]" class="form-control input-right item-price">
                        </td>
                        <td>
                            <input type="text" name="items[${rowIndex}][amount]" class="form-control input-right item-amount" value="0.00" readonly>
                        </td>
                        <td>
                            <div class="form-check">
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response) {
                                ...
                                $row.find('.item-price').val(response.sale_price || 0);
                                recalcRow($row);
                            }
                        }
                    });
