...
use App\Http\Controllers\AssignTargetController;
...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
        ...
        function () {
            ...
            Route::get('report/deposits', [TransactionController::class, 'incomeSummary'])->name('report.income.summaryTransactionsDeposites');
    ...
    Route::get('get-field-options/{id}', [CustomFieldController::class, 'getFieldOptions'])->name('getlistfields');
    ...
    Route::post('/ai/dynamic-reporting', [ciaController::class, 'dynamicreporting'])->name('dynamic_reporting');
    // Client Module

    Route::resource('clients', ClientController::class)->middleware(['auth', 'XSS']);
    Route::get('/workflow/hrm-create', [WorkflowController::class, 'workflowHrm'])->name(name: 'workflow_hrm');
    Route::get('/workflow/project-create', action: [WorkflowController::class, 'workflowProject'])->name(name: 'workflow_project');
    Route::get('/workflow/account-create', [WorkflowController::class, 'workflowAccount'])->name(name: 'workflow_account');
    Route::post('/workflows/{id}/status', [WorkflowController::class, 'updateStatus'])->name('workflows.updateStatus');
    Route::get('workflow/{type}', [WorkflowController::class, 'index'])->name('workflow.index.type');
    ...
    Route::resource('assign-target', AssignTargetController::class);
    ...
    Route::get('/leads/filter', [LeadController::class, 'filterlead'])->name('leads.filtermodal')->middleware(['auth', 'XSS']);
    // Route::post('/leads/{id}/updatestage', [LeadController::class, 'updatestagemove'])->name('leads.poststagemove')->middleware(['auth', 'XSS']);
    ...
    Route::get('/leads/{id}/stage', [LeadController::class, 'stagemove'])->name('leads.stagemove')->middleware(['auth', 'XSS']);
    Route::post('/leads/{id}/updatestage', [LeadController::class, 'updatestagemove'])->name('leads.poststagemove')->middleware(['auth', 'XSS']);
    ...
    Route::get('/leads/export/{id?}', [LeadController::class, 'export'])->name('leads.export')->middleware(['auth', 'XSS']);
    Route::post('import/leads', [LeadController::class, 'import'])->name('leads.import');
    Route::get('import/leads/file/{id?}', [LeadController::class, 'importFile'])->name('leads.file.import');
    ...
    Route::get('employee_create', [SetSalaryController::class, 'employee_create'])->name('employee_create')->middleware(['auth', 'XSS']);
    Route::post('employee_store', [SetSalaryController::class, 'employee_store'])->name('employee_store')->middleware(['auth', 'XSS']);
    //payslip
    ...
    // Report To Leave
    Route::get('leaveto', [LeaveController::class, 'leaveto'])->name('leaveto')->middleware(['auth', 'XSS']);
    Route::get('leavecreate', [LeaveController::class, 'report_to_create'])->name('leavecreate')->middleware(['auth', 'XSS']);
    // Report for apparisal
    Route::get('appraisal-list', [AppraisalController::class, 'appraisal_list'])->name('appraisal_list')->middleware(['auth', 'XSS']);
...
Route::get('change/theme/{mode}', [UserController::class, 'themeChange']);
